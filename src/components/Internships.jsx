...
const InternshipCard = ({ intern, index }) => (
  <div 
    ...
    className="relative overflow-hidden group bg-black/20 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:scale-[1.02] hover:bg-black/35 hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-500 flex flex-col justify-between cursor-pointer"
  >
