...
const ProjectCard = ({ project, aosDelay }) => (
  <div 
    ...
    className="relative overflow-hidden rounded-2xl p-[1px] group transition-transform duration-500 cursor-pointer hover:scale-[0.98] bg-gradient-to-br from-red-500/50 via-white/10 to-red-500/30 hover:from-red-500 hover:via-red-400/30 hover:to-red-500/60 shadow-[0_8px_32px_rgba(0,0,0,0.3)]"
  >
    <div className="absolute inset-0 -translate-x-[150%] skew-x-[-25deg] bg-gradient-to-r from-transparent via-white/10 to-transparent group-hover:animate-[swipe_1s_ease-in-out_forwards] z-20 pointer-events-none transition-all duration-700 group-hover:translate-x-[150%]"></div>
    <div className="relative z-10 rounded-2xl p-6 md:p-8 h-full backdrop-blur-md transition-all duration-500 bg-[#0f0f0f]/95 group-hover:bg-[#0f0f0f]/90">
      {/* Badge */}
      {project.badge && (
